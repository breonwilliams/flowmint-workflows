 ...
 * Step: log_info
 *
 * Logs an info-level message to the FMW logger.
 *
...
class FMW_Step_Log_Info extends FMW_Step_Base {
    ...
    public static function description(): string {
        return 'Writes an INFO-level message to the workflow log. Variables are interpolated. Useful for tracing.';
    }
    ...
    public function execute( FMW_Workflow_Context $context ): array {
        ...
        FMW_Logger::info( $message, $log_context );
